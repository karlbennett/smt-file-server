...
public class FileSystemElementSteps {
    ...
    public static void The_files_extension_should_be_correct(FileSystemElementCreator creator) {
        ...
        The_file_system_elements_extension_should_be_correct("", creator.create(FILE_TWO_PATH));
    ...
    public static void The_file_should_be_able_to_be_serialised(FileSystemElementCreator creator) {
        ...
        The_file_system_element_should_be_able_to_be_serialised(creator.create(FILE_ONE_PATH), FILE_ONE_NAME,
                FILE_EXTENSION, Long.toString(FILE_ONE_MODIFICATION_DATE.getTime()));
        The_file_system_element_should_be_able_to_be_serialised(creator.create(FILE_TWO_PATH), FILE_TWO_NAME, "",
                Long.toString(FILE_TWO_MODIFICATION_DATE.getTime()));
        The_file_system_element_should_be_able_to_be_serialised(creator.create(FILE_THREE_PATH), FILE_THREE_NAME,
                FILE_EXTENSION, Long.toString(FILE_THREE_MODIFICATION_DATE.getTime()));
        The_file_system_element_should_be_able_to_be_serialised(creator.create(FILE_FOUR_PATH), FILE_FOUR_NAME,
                FILE_EXTENSION, Long.toString(FILE_FOUR_MODIFICATION_DATE.getTime()));
    }

    public static void The_directory_should_be_able_to_be_serialised(FileSystemElementCreator creator) {

        The_file_system_element_should_be_able_to_be_serialised(creator.create(CURRENT_DIRECTORY_PATH),
                CURRENT_DIRECTORY_NAME, "", Long.toString(CURRENT_DIRECTORY_MODIFICATION_DATE.getTime()));
        The_file_system_element_should_be_able_to_be_serialised(creator.create(DIRECTORY_ONE_PATH), DIRECTORY_ONE_NAME,
                "", Long.toString(DIRECTORY_ONE_MODIFICATION_DATE.getTime()));
        The_file_system_element_should_be_able_to_be_serialised(creator.create(DIRECTORY_TWO_PATH), DIRECTORY_TWO_NAME,
                "", Long.toString(DIRECTORY_TWO_MODIFICATION_DATE.getTime()));
        The_file_system_element_should_be_able_to_be_serialised(creator.create(DIRECTORY_THREE_PATH), DIRECTORY_THREE_NAME,
                "", Long.toString(DIRECTORY_THREE_MODIFICATION_DATE.getTime()));
        The_file_system_element_should_be_able_to_be_serialised(creator.create(DIRECTORY_FOUR_PATH), DIRECTORY_FOUR_NAME,
                "", Long.toString(DIRECTORY_FOUR_MODIFICATION_DATE.getTime()));
    }
