...
public class DefaultAwareExceptionHandlerExceptionResolverTest {
    ...
    private WrappedExceptionHandlerExceptionResolver exceptionHandlerExceptionResolver;
    ...
    private static WrappedExceptionHandlerExceptionResolver createExceptionHandlerExceptionResolver() {

        return new WrappedExceptionHandlerExceptionResolver(new ExceptionHandlerExceptionResolver());
    }
    ...
    /**
     * Have wrapped the annotation of the {@link ExceptionHandlerAdvice} within a method to hide it from any component
     * scanning.
     */
    private static ExceptionHandlerAdvice annotatedExceptionHandlerAdvice() {

        @ControllerAdvice
        class AnnotatedExceptionHandlerAdvice extends ExceptionHandlerAdvice {
        }

        return new AnnotatedExceptionHandlerAdvice();
    }
    ...
    private static class Config {
        ...
        public ExceptionHandlerAdvice exceptionHandlerAdvice() {
            return annotatedExceptionHandlerAdvice();
        }
    }
}
