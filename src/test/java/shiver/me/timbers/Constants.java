...
public class Constants {
    ...
    public static final Properties TEST_PROPERTIES = openTestPropertiesFile();
    ...
    private static Properties openTestPropertiesFile() {

        return openPropertiesFile(TEST_PROPERTIES_FILE_NAME);
    }
